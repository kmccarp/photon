...
public class AssetMapBuilderFunctionalTest {
    ...
    public void assetMapBuilderTest() throws IOException, SAXException, JAXBException, URISyntaxException {
        ...
        for(AssetMap.Asset asset : assets){
            ...
            AssetMapBuilder.Asset assetMapBuilderAsset = new AssetMapBuilder.Asset(asset.getUUID(), AssetMapBuilder.buildAssetMapUserTextType2007(annotationText, language), asset.isPackingList(), chunks);
            assetMapBuilderAssets.add(assetMapBuilderAsset);
        }

        org.smpte_ra.schemas._429_9._2007.am.UserText annotationText = AssetMapBuilder.buildAssetMapUserTextType2007("Photon AssetMapBuilder", "en");
        org.smpte_ra.schemas._429_9._2007.am.UserText creator = AssetMapBuilder.buildAssetMapUserTextType2007("Netflix", "en");
        XMLGregorianCalendar issueDate = IMFUtils.createXMLGregorianCalendar();
        org.smpte_ra.schemas._429_9._2007.am.UserText issuer = AssetMapBuilder.buildAssetMapUserTextType2007("Netflix", "en");
