...
public final class RegXMLLibDictionary {
    ...
    public Integer getEnumerationValueFromName(String typeURN, String name) {
        ...
        if(definition == null ) {
            ...
            List<Integer> enumList = enumerationTypeDefinition.getElements().stream().filter(e -> e.getName().equals(name)).map(com.sandflow.smpte.regxml.dict.definitions.EnumerationTypeDefinition.Element::getValue).collect(Collectors.toList());
    ...
    public String getTypeFieldNameFromURN(String typeURN, String fieldURN) {
        ...
        if(definition == null ) {
            ...
            List<String> enumList = recordTypeDefinition.getMembers().stream().filter(e -> e.getType().equals(AUID.fromURN(fieldURN))).map(com.sandflow.smpte.regxml.dict.definitions.RecordTypeDefinition.Member::getName).collect(Collectors.toList());
